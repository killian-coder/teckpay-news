            ...
            <div class="col-lg-3">
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <input placeholder="Search for latest News..." type="text" class="form-control">
                ...
                <div class="d-flex flex-column flex-md-row mb-3 mb-md-0">
                    <nav class="mr-auto d-flex align-items-center" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active breadcrumb-item" aria-current="page">Headlines</li>
                        </ol>
                    </nav>
                        ...
                        <table class="mb-0 table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-middle bt-0">Author</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div><a href="#">Ergonomic real-time adapter</a></div><span>Last Edited
                                            by: Savanah Durgan <br>Sunday, 12 June, 2018</span>
                                    </td>
                                    <td class="align-middle"><span
                                            class="badge badge-success badge-pill">Active</span></td>
                                    <td class="align-middle">
